...
PetClinic JDBC Host
*/}}
{{- define "petclinic.jdbc.url" -}}
{{- printf "jdbc:postgresql://%s:%s/%s" .Values.deployment.datasource.db_host (.Values.deployment.datasource.db_port | toString ) .Values.deployment.datasource.db_name -}}
{{- end }}